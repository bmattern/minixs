...
DIR = "/home/bmattern/research/Fe_K_Beta/data/Fe6N/"
...
calib_root = DIR + 'spot3_calib_'
calib_nums = range(1,16)
calib_scan = DIR + 'spot3_calib.0001'
...
if do_process:
  ...
  import glob
  files = glob.glob(DIR+"spot3_0*.tif")
  ...
  e = minixs.Exposure()
  e.load_multi(files[0:2])
  s = minixs.emission_spectrum(cal, e, 7000, 7140, .7, 1)
  savetxt(DIR+'spot3_2min.dat', s)

  e = minixs.Exposure()
  e.load_multi(files[0:3])
  s = minixs.emission_spectrum(cal, e, 7000, 7140, .7, 1)
  savetxt(DIR+'spot3_3min.dat', s)

  e = minixs.Exposure()
  e.load_multi(files)
  s = minixs.emission_spectrum(cal, e, 7000, 7140, .7, 1)
  savetxt(DIR+'spot3_all.dat', s)
